...
namespace MongoDB.MSTest
{
    ...
    public class DBCursorTest
    {
            ...
            where TDoc : class , IDocument
        {
            ...
            DBCursor_Accessor<TDoc> target = new DBCursor_Accessor<TDoc>(options);
        ...
        {
            DBCursorOptions options = null; // TODO: Initialize to an appropriate value
            DBCursor_Accessor target = new DBCursor_Accessor(options);
            Assert.Inconclusive("TODO: Implement code to verify target");
        }
        ...
        public void CleanupCursorsTest()
        {
            ...
            DBCursor_Accessor.CleanupCursors(collection);
