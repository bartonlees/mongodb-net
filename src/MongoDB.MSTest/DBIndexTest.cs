...
namespace MongoDB.MSTest
{
    ...
    public class DBIndexTest
    {
        ...
        {
            DBCollection collection = null; // TODO: Initialize to an appropriate value
            ...
            DBIndex target = new DBIndex(collection, indexUri, indexKeyFieldSet, unique);
        ...
        public void NameTest()
        {
            ...
            DBFieldSet indexKeyFieldSet = null; // TODO: Initialize to an appropriate value
            bool unique = false; // TODO: Initialize to an appropriate value
            DBIndex target = new DBIndex(collection, indexUri, indexKeyFieldSet, unique); // TODO: Initialize to an appropriate value
            string actual;
            actual = target.Name;
            Assert.Inconclusive("Verify the correctness of this test method.");
        }
