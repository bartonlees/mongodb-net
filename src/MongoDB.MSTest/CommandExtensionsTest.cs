...
namespace MongoDB.MSTest
{
    ...
    public class CommandExtensionsTest
    {
        ...
        public void assertinfoTest()
        {
            ...
            AssertInfo actual;
            actual = CommandExtensions_Accessor.assertinfo(db);
            Assert.AreEqual(expected, actual);
            Assert.Inconclusive("Verify the correctness of this test method.");
        }
        ...
        public void authenticateTest()
        {
            ...
            string nonce = string.Empty; // TODO: Initialize to an appropriate value
            SecureString key = null; // TODO: Initialize to an appropriate value
            CommandExtensions_Accessor.authenticate(db, username, nonce, key);
        ...
        public void authenticateTest1()
        {
            ...
            bool actual;
            actual = CommandExtensions_Accessor.authenticate(connection, collection, username, nonce, key);
            Assert.AreEqual(expected, actual);
            Assert.Inconclusive("Verify the correctness of this test method.");
        }
        ...
        public void createTest()
        {
            ...
            CommandExtensions_Accessor.create(db, collectionName, options);
            Assert.Inconclusive("A method that does not return a value cannot be verified.");
        }
        ...
        public void deleteIndexesTest()
        {
            ...
            CommandExtensions_Accessor.deleteIndexes(db, collection, indexName);
            Assert.Inconclusive("A method that does not return a value cannot be verified.");
        }
        ...
        public void driverOIDTestTest()
        {
            ...
            string actual;
            actual = CommandExtensions_Accessor.driverOIDTest(db, id);
            Assert.AreEqual(expected, actual);
            Assert.Inconclusive("Verify the correctness of this test method.");
        }
        ...
        public void dropTest()
        {
            ...
            CommandExtensions_Accessor.drop(db, collectionFullName);
            Assert.Inconclusive("A method that does not return a value cannot be verified.");
        }
        ...
        public void dropDatabaseTest()
        {
            ...
            CommandExtensions_Accessor.dropDatabase(db, dbName);
            Assert.Inconclusive("A method that does not return a value cannot be verified.");
        }
        ...
        public void evalTest()
        {
            ...
            object actual;
            actual = CommandExtensions_Accessor.eval(db, code, args);
            Assert.AreEqual(expected, actual);
            Assert.Inconclusive("Verify the correctness of this test method.");
        }
        ...
        public void forceerrorTest()
        {
            ...
            DBError actual;
            actual = CommandExtensions_Accessor.forceerror(db);
            Assert.AreEqual(expected, actual);
            Assert.Inconclusive("Verify the correctness of this test method.");
        }
        ...
        public void getlasterrorTest()
        {
            ...
            LastError actual;
            actual = CommandExtensions_Accessor.getlasterror(db);
            Assert.AreEqual(expected, actual);
            Assert.Inconclusive("Verify the correctness of this test method.");
        }
        ...
        public void getoptimeTest()
        {
            ...
            OpTime actual;
            actual = CommandExtensions_Accessor.getoptime(db);
            Assert.AreEqual(expected, actual);
            Assert.Inconclusive("Verify the correctness of this test method.");
        }
        ...
        public void getpreverrorTest()
        {
            ...
            PrevError actual;
            actual = CommandExtensions_Accessor.getpreverror(db);
            Assert.AreEqual(expected, actual);
            Assert.Inconclusive("Verify the correctness of this test method.");
        }
        ...
        public void groupTest()
        {
            ...
            IDBObject actual;
            actual = CommandExtensions_Accessor.group(db, collection, key, cond, initial, reduce);
            Assert.AreEqual(expected, actual);
            Assert.Inconclusive("Verify the correctness of this test method.");
        }
        ...
        public void nonceTest()
        {
            ...
            string expected = string.Empty; // TODO: Initialize to an appropriate value
            string actual;
            actual = CommandExtensions_Accessor.nonce(connection, cmdCollection);
            Assert.AreEqual(expected, actual);
            Assert.Inconclusive("Verify the correctness of this test method.");
        }
        ...
        public void nonceTest1()
        {
            ...
            string expected = string.Empty; // TODO: Initialize to an appropriate value
            string actual;
            actual = CommandExtensions_Accessor.nonce(db);
            Assert.AreEqual(expected, actual);
            Assert.Inconclusive("Verify the correctness of this test method.");
        }
        ...
        public void renameCollectionTest()
        {
            ...
            CommandExtensions_Accessor.renameCollection(database, collectionUri, newCollectionUri);
            Assert.Inconclusive("A method that does not return a value cannot be verified.");
        }
        ...
        {
            IDatabase db = null; // TODO: Initialize to an appropriate value
            CommandExtensions_Accessor.reseterror(db);
            Assert.Inconclusive("A method that does not return a value cannot be verified.");
        }
    }
}
