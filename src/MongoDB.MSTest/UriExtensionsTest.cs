...
namespace MongoDB.MSTest
{
    ...
    public class UriExtensionsTest
    {
        ...
        public void GetCollectionNameTest()
        {
            ...
            string actual;
            actual = UriExtensions_Accessor.GetCollectionName(collectionUri);
        ...
        public void GetDatabaseNameTest()
        {
            ...
            string expected = string.Empty; // TODO: Initialize to an appropriate value
            string actual;
            actual = UriExtensions_Accessor.GetDatabaseName(databaseUri);
            Assert.AreEqual(expected, actual);
            Assert.Inconclusive("Verify the correctness of this test method.");
        }
        ...
        public void GetFullCollectionNameTest()
        {
            ...
            string expected = string.Empty; // TODO: Initialize to an appropriate value
            string actual;
            actual = UriExtensions_Accessor.GetFullCollectionName(collectionUri);
            Assert.AreEqual(expected, actual);
            Assert.Inconclusive("Verify the correctness of this test method.");
        }
        ...
        public void GetIndexNameTest()
        {
            ...
            string expected = string.Empty; // TODO: Initialize to an appropriate value
            string actual;
            actual = UriExtensions_Accessor.GetIndexName(indexUri);
            Assert.AreEqual(expected, actual);
            Assert.Inconclusive("Verify the correctness of this test method.");
        }
    }
