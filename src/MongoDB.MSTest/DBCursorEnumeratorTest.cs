...
namespace MongoDB.MSTest
{
    ...
    public class DBCursorEnumeratorTest
    {
        ...
        {
            DBCursor<TDoc> cursor = null; // TODO: Initialize to an appropriate value
            DBCursorEnumerator<TDoc> target = new DBCursorEnumerator<TDoc>(cursor);
        ...
        {
            DBCursor<TDoc> cursor = null; // TODO: Initialize to an appropriate value
            DBCursorEnumerator<TDoc> target = new DBCursorEnumerator<TDoc>(cursor); // TODO: Initialize to an appropriate value
            target.Dispose();
            Assert.Inconclusive("A method that does not return a value cannot be verified.");
        }
        ...
        {
            DBCursor<TDoc> cursor = null; // TODO: Initialize to an appropriate value
            IEnumerator target = new DBCursorEnumerator<TDoc>(cursor); // TODO: Initialize to an appropriate value
            object actual;
            actual = target.Current;
            Assert.Inconclusive("Verify the correctness of this test method.");
        }
