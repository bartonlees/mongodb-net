...
namespace MongoDB.MSTest
{
    ...
    public class DBCursorOptionsTest
    {
        ...
        public void DBCursorOptionsConstructorTest()
        {
            ...
            DBCursorOptions_Accessor target = new DBCursorOptions_Accessor(collection, selector, returnFields, orderBy, numberToSkip, numberToReturn, limit, explain, snapshot, options, explicitIndexHint);
